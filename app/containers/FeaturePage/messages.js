...
export default defineMessages({
  header: {
    id: 'epiaggregator.containers.FeaturePage.header',
    defaultMessage: 'Features',
  },
  scaffoldingHeader: {
    id: 'epiaggregator.containers.FeaturePage.scaffolding.header',
    defaultMessage: 'Quick scaffolding',
  },
  scaffoldingMessage: {
    id: 'epiaggregator.containers.FeaturePage.scaffolding.message',
    defaultMessage: `Automate the creation of components, containers, routes, selectors
  and sagas - and their tests - right from the CLI!`,
  },
  feedbackHeader: {
    id: 'epiaggregator.containers.FeaturePage.feedback.header',
    defaultMessage: 'Instant feedback',
  },
  feedbackMessage: {
    id: 'epiaggregator.containers.FeaturePage.feedback.message',
    defaultMessage: `
  ...
  stateManagementHeader: {
    id: 'epiaggregator.containers.FeaturePage.state_management.header',
    defaultMessage: 'Predictable state management',
  },
  stateManagementMessages: {
    id: 'epiaggregator.containers.FeaturePage.state_management.message',
    defaultMessage: `
  ...
  javascriptHeader: {
    id: 'epiaggregator.containers.FeaturePage.javascript.header',
    defaultMessage: 'Next generation JavaScript',
  },
  javascriptMessage: {
    id: 'epiaggregator.containers.FeaturePage.javascript.message',
    defaultMessage: `Use template strings, object destructuring, arrow functions, JSX
    syntax and more, today.`,
  },
  cssHeader: {
    id: 'epiaggregator.containers.FeaturePage.css.header',
    defaultMessage: 'Features',
  },
  cssMessage: {
    id: 'epiaggregator.containers.FeaturePage.css.message',
    defaultMessage: 'Next generation CSS',
  },
  routingHeader: {
    id: 'epiaggregator.containers.FeaturePage.routing.header',
    defaultMessage: 'Industry-standard routing',
  },
  routingMessage: {
    id: 'epiaggregator.containers.FeaturePage.routing.message',
    defaultMessage: `
  ...
  networkHeader: {
    id: 'epiaggregator.containers.FeaturePage.network.header',
    defaultMessage: 'Offline-first',
  },
  networkMessage: {
    id: 'epiaggregator.containers.FeaturePage.network.message',
    defaultMessage: `
  ...
  intlHeader: {
    id: 'epiaggregator.containers.FeaturePage.internationalization.header',
    defaultMessage: 'Complete i18n Standard Internationalization & Pluralization',
  },
  intlMessage: {
    id: 'epiaggregator.containers.FeaturePage.internationalization.message',
